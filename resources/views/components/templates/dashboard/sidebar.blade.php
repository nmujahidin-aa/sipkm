    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">
                            {{ \App\Helpers\RoleHelper::getRoleName(Auth::user()->current_role_id) }}
                        </span>
                    </div>
                </div>

                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('proposal.*') || request()->routeIs('admin.proposal.*') || request()->routeIs('dosen.proposal.*') ? 'active' : '' }}" href="{{ route(\App\Helpers\MenuHelper::getMenuProposal(Auth::user()->current_role_id)) }}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('belmawa.*') || request()->routeIs('admin.belmawa.*') || request()->routeIs('dosen.belmawa.*') ? 'active' : '' }}" href="{{ route(\App\Helpers\MenuHelper::getMenuBelmawa(Auth::user()->current_role_id)) }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">Belmawa</span>
                    </a>
                </div>
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Tambahan</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="https://drive.google.com/drive/folders/1G75Qma1-TtuhaazjEKjxbxyD4n_9H5d7?usp=sharing" target="_blank">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                @if (Auth::user()->current_role_id == 1 || Auth::user()->current_role_id == 5)
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin.lecturer.*') ? 'active' : '' }}" href="{{route('admin.lecturer.index')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin.study-program.*') ? 'active' : '' }}" href="{{route('admin.study-program.index')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
