                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table align-middle gy-3" id="kt_table_users_login_session">
                                                ...
                                                <tbody class="fs-6 fw-bold text-gray-600">
                                                    ...
                                                    <tr>
                                                        <td class="fixed-width-30">NIDN <span class="text-secondary">(opsional)</span></td>
                                                        <td class="fixed-width-70">
                                                    ...
                                                    <tr>
                                                        <td class="fixed-width-30">NIP <span class="text-secondary">(opsional)</span></td>
                                                        <td class="fixed-width-70">
                                                    ...
                                                    <tr>
                                                        <td class="fixed-width-30">NUPTK <span class="text-secondary">(opsional)</span></td>
                                                        <td class="fixed-width-70">
