@extends('layouts.app')
@section('title', 'Data PROGRAM STUDI | SIPKM UM')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Cari Program Studi" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <!--end::Export-->
                            <!--begin::Add user-->
                            <a href="{{route('admin.study-program.edit')}}" class="btn btn-primary">
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            @foreach ($studyPrograms as $index => $row)
                            <!--begin::Table row-->
                            <tr>
                                <!--begin::Checkbox-->
                                <!--end::Checkbox-->
                                ...
                                <td class="text-end">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{route('admin.study-program.edit', $row->id)}}" class="btn btn-light btn-active-light-primary btn-sm">
        ...
        $(document).on("click", ".btn-delete", function(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $("#frmDelete").attr("action", "{{ route('admin.study-program.single_destroy', '_id_') }}".replace("_id_", id));
