...
@section('title')
    {{ isset($belmawa) ? 'Ubah Akun Belmawa: ' . $belmawa->name : 'Tambah Akun Belmawa' }}
@endsection
...
<div class="page-title d-flex flex-column me-5">
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
        ...
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">
            <a href="{{route('admin.belmawa.index')}}" class="text-muted text-hover-primary">Data Belmawa</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-200 w-5px h-2px"></span>
        </li>
        <li class="breadcrumb-item text-dark">
            {{ isset($belmawa) ? 'Ubah Data Dosen: ' : 'Tambah Dosen' }}
        </li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="d-flex align-items-center mb-3">
                <a href="{{ route('admin.belmawa.index') }}" class="btn btn-white">
                    <i class="bi bi-arrow-left"></i>
                </a>
                <div class="ms-3">
                    <h3 class="card-header-title mb-1">
                        <i class="bi-people me-2 fs-3"></i>
                        {{ isset($belmawa) ? 'Ubah' : 'Tambah' }} Akun Belmawa
                    </h3>
                        ...
                        <div class="card-body pt-2">
                            ...
                            <div class="notice d-flex bg-light-danger rounded border-danger border border-dashed mb-9 p-6">
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <!--begin::Content-->
                                    <div class="fw-bold">
                                        <div class="fs-6 text-gray-700">Isi data dengan benar dan teliti. Pastikan username dan password akun belmawa sesuai dengan yang tertera di Simbelmawa</div>
                                    </div>
                                    <!--end::Content-->
                                </div>
                                <!--end::Wrapper-->
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="kt_user_view_overview_security" role="tabpanel">
                            <!--begin::Card-->
                            <form action="{{route('admin.belmawa.store')}}" method="POST">
                                @csrf
                                <div class="card pt-4 mb-6 mb-xl-9">
                                    ...
                                    <div class="card-header">
                                        <!--begin::Card title-->
                                        <div class="card-title">
                                            <h2>Data Akun Belmawa</h2>
                                        </div>
                                        <!--end::Card title-->
                                    </div>
                                    @if (isset($belmawa))
                                        <input type="hidden" name="id" value="{{ $belmawa->id }}" autocomplete="off">
                                    @endif
                                    <div class="card-body pt-5 pb-5">
                                        <div class="row mb-4 align-items-center">
                                            <label class="col-lg-3 col-form-label">Nama <span class="text-danger">*</span></label>
                                            <div class="col-lg-9">
                                                <select name="user_id" class="form-select @error('user_id') is-invalid @enderror" data-control="select2" data-placeholder="Select an option">
                                                    <option></option>
                                                    @foreach ($user as $row)
                                                        <option
                                                            value="{{ $row->id }}"
                                                            {{ old('user_id') == $row->id || (isset($belmawa) && $belmawa->user_id == $row->id) ? 'selected' : '' }}
                                                            {{ in_array($row->id, $existingUserIds) ? 'disabled' : '' }}
                                                        >
                                                            {{ $row->name }}
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') ? old('username') : (isset($belmawa) ? $belmawa->username : '') }}">
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" name="password" class="form-control @error('password') is-invalid @enderror" value="{{ old('password') ? old('password') : (isset($belmawa) ? $belmawa->password : '') }}">
