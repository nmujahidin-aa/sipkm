    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="d-flex align-items-center mb-3">
                <a href="{{ route('dosen.proposal.index') }}" class="btn btn-white">
                    <i class="bi bi-arrow-left"></i>
                </a>
                <div class="ms-3">
                    <h3 class="card-header-title mb-1">
                        <i class="bi-people me-2 fs-3"></i>
                        Detail Proposal Bimbingan
                    </h3>
            ...
            <div class="alert alert-success fade show mb-5 d-flex align-items-center" role="alert">
                ...
                <div>
                    ...
                    <p class="mb-0">Proposal bimbingan Anda telah memenuhi kriteria untuk melanjutkan ke tahap selanjutnya. Jangan lupa untuk menghubungi mentor guna mendapatkan pendampingan lebih lanjut.</p>
                </div>
            </div>
            ...
            <div class="alert alert-danger fade show mb-5 d-flex align-items-center" role="alert">
                ...
                <div>
                    ...
                    <p class="mb-0">Mohon maaf, proposal bimbingan Anda belum memenuhi kriteria untuk melanjutkan ke tahap selanjutnya. Jangan patah semangat, perbaiki proposal Anda dan coba lagi!</p>
                </div>
            </div>
            @else
            <div class="alert alert-primary fade show mb-5 d-flex align-items-center" role="alert">
                ...
                <div>
                    ...
                    <p class="mb-0">Proposal bimbingan Anda saat ini sedang dalam proses peninjauan. Mohon bersabar dan tetap semangat. Semoga hasilnya yang terbaik untuk Anda!</p>
                </div>
            </div>
            @endif
            @endisset
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="d-flex justify-content-end align-items-center" data-kt-user-table-toolbar="base">
                                            <a href="{{route('dosen.proposal.review', $proposal->id)}}" class="btn btn-light-primary me-3 custom-input" data-kt-menu-placement="bottom-end">
                                    ...
                                    <table class="table align-top table-striped table-row-dashed fs-6 gy-5" id="kt_table_users">
                                        ...
                                        <tbody class="text-gray-600 fw-bold">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('dosen.proposal.review', ['proposal_id'=>$row->proposal_id, 'id'=>$row->id]) }}" class="btn btn-sm btn-primary"><i class="bi @if ($row->status == 0) bi-pencil-square @else bi-eye @endif"></i></a>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <!--end::Table row-->
